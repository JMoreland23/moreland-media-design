        ...
        <div className="gallery row md-marg">
          <div className="col-lg-4 col-md-6 items design">
            <div className="item mb-50">
              ...
              <div className="cont d-flex align-items-end mt-30">
                <div>
                  <span className="p-color mb-5 sub-title">Digital Foundation</span>
                  <h6>Coastal Green Landscaping</h6>
                </div>
                <div className="ml-auto">
                  <a href="/portfolio/coastal-green-landscaping">
          ...
          <div className="col-lg-4 col-md-6 items marketing">
            <div className="item mb-50">
              ...
              <div className="cont d-flex align-items-end mt-30">
                <div>
                  <span className="p-color mb-5 sub-title">Digital E-Commerce Store</span>
                  <h6>Morelan3D</h6>
                </div>
                <div className="ml-auto">
          ...
          <div className="col-lg-4 col-md-6 items design">
            <div className="item mb-50">
              ...
              <div className="cont d-flex align-items-end mt-30">
                <div>
                  <span className="p-color mb-5 sub-title">Search Engine Optimization</span>
                  <h6>San Diego Dumpster Rentals</h6>
                </div>
                <div className="ml-auto">
                  <a href="/project-details">
                    <span className="ti-arrow-top-right"></span>
          ...
          <div className="col-lg-4 col-md-6 items development">
            <div className="item mb-50">
              ...
              <div className="cont d-flex align-items-end mt-30">
                <div>
                  <span className="p-color mb-5 sub-title">E-Commerce</span>
                  <h6>Bolero USA Glass Tile</h6>
                </div>
                <div className="ml-auto">
                  <a href="/project-details">
                    <span className="ti-arrow-top-right"></span>
